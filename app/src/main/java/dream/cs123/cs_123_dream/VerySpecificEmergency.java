...
public class VerySpecificEmergency extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_very_specific_emergency);
        ...
        final RecyclerView rV = (RecyclerView) findViewById(R.id.seb1);
...
//        --- standard
    ...
    public void very_specific_emergency1_back_button (View view) {
        finish();
    }
